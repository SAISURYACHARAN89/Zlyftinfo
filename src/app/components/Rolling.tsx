          ...
          {galleryImages.map((url, i) => (
            ...
            >
              <img
                src={url}
                alt="gallery"
                className="pointer-events-none h-[120px] w-[250px] rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-105 sm:h-[100px] sm:w-[220px]"
              />
            </div>
          ))}
        </motion.div>
